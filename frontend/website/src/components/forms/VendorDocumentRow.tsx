         ...
         <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className={`${showValidity ? 'md:col-span-4' : 'md:col-span-7'}`}>
               ...
               <input 
                  ...
                  className="w-full bg-white border border-[#262A2B]/10 rounded-xl px-4 py-3 text-[#262A2B] text-sm outline-none focus:border-[#4A6741] focus:ring-2 focus:ring-[#4A6741]/10 transition-all placeholder:text-[#262A2B]/30" 
            ...
            {showValidity && (
               <div className="md:col-span-3">
                  ...
                  <input 
                     ...
                     className="w-full bg-white border border-[#262A2B]/10 rounded-xl px-4 py-3 text-[#262A2B] text-sm outline-none focus:border-[#4A6741] focus:ring-2 focus:ring-[#4A6741]/10 transition-all" 
                  />
               </div>
            )}
         </div>
