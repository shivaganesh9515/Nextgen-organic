                  ...
                  <AnimatePresence mode="wait">
                    {activeCategory ? (
                      ...
                      <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="h-full flex items-center justify-center text-gray-500 min-h-[200px] bg-gray-50 rounded-lg"
                      >
                        <p className="text-center">Select a category to view subcategories and featured products.</p>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </div>
