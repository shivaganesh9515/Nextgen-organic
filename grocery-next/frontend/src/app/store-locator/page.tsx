            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-white/20 h-full">
              ...
              >
                ...
                <div className="absolute inset-0 opacity-20">
                  {/* Organic grid pattern with subtle animation */}
                  <div className="grid grid-cols-8 grid-rows-6 h-full">
                    {Array.from({ length: 48 }).map((_, i) => (
                      <div 
                        key={i} 
                        className="border border-gray-200 hover:bg-green-100 transition-colors duration-300"
                      ></div>
                    ))}
                  </div>
                  
                  {/* Floating organic elements */}
                  <div className="absolute top-10 left-10 w-8 h-8 rounded-full bg-green-200 opacity-30 animate-pulse"></div>
                  <div className="absolute top-20 right-20 w-6 h-6 rounded-full bg-blue-200 opacity-30 animate-pulse delay-1000"></div>
                  <div className="absolute bottom-16 left-16 w-10 h-10 rounded-lg bg-yellow-200 opacity-20 transform rotate-12 animate-pulse delay-1500"></div>
                  <div className="absolute bottom-24 right-32 w-4 h-4 rounded-full bg-purple-200 opacity-30 animate-pulse delay-700"></div>
                </div>
