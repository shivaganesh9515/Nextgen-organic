    ...
    <ScreenWrapper bg="bg-white">
      <View className="flex-1 px-6">
        ...
        <View className="mt-12 mb-8">
             <ThemedText variant="h1" color="dark" className="font-heading mb-2 text-3xl">Hi! Welcome back</ThemedText>
             <ThemedText variant="body" color="gray" className="text-base text-gray-400">Sign in to your account</ThemedText>
        </View>
        ...
        <View className="flex-row items-center mb-8">
            ...
            <ThemedText variant="caption" color="gray" className="mx-4 text-gray-400">Or sign in with</ThemedText>
            <View className="flex-1 h-[1px] bg-gray-100" />
        </View>

        {/* Social Actions */}
        <View className="space-y-4 mb-10 gap-4">
            <TouchableOpacity className="w-full bg-white border border-gray-100 h-14 rounded-full items-center flex-row justify-center space-x-3 shadow-sm">
                ...
                <ThemedText weight="medium">Sign In with Apple</ThemedText>
            </TouchableOpacity>
            <TouchableOpacity className="w-full bg-white border border-gray-100 h-14 rounded-full items-center flex-row justify-center space-x-3 shadow-sm">
                <ThemedText className="mr-2">🔵</ThemedText>
                <ThemedText weight="medium">Sign In with Google</ThemedText>
            </TouchableOpacity>
        </View>
